...
param NBS {i in 1..T1, j in 1..T2};

param NA1 {i in 1..T1, j in 1..T2};
param NA2 {i in 1..T1, j in 1..T2};
param NA3 {i in 1..T1, j in 1..T2};
param NA4 {i in 1..T1, j in 1..T2};

param NCP1 {i in 1..T1, j in 1..T2};
param NCP2 {i in 1..T1, j in 1..T2};

param NBP1 {i in 1..T1, j in 1..T2};
param NBP2 {i in 1..T1, j in 1..T2};
param NPB3 {i in 1..T1, j in 1..T2};
param NBP4 {i in 1..T1, j in 1..T2};
